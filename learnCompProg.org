...
3. Saving time and effort. Often, mind-numbing and repetitive tasks on a computer can be automated. This saves time and energy, and eliminates human fatigue along with associated human errors that may be made. When tasks are automated, humans are liberated to perform other tasks that are not so easily automated; productivity is increased, and the cost of labor for automated tasks is saved. Automated tasks can be as simple as renaming several photos in a consistent way or finding and deleting duplicate photos in your photo library. Personally, I've saved thousands of person-hours of labor in reading, analyzing, and visualizing scientific data, and I've taught friends to do the same.
